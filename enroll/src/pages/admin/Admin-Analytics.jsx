          ...
          <div className="enrollmentForecast" style={{ minWidth: 0 }}>
            ...
            >
              <div className='enrollmentForecastP1'>
                ...
                <div className="enrollmentForecastGraph card1" style={{ minWidth: 0 }}>
                ...
                <div className="enrollmentForecastGraph card1" style={{ minWidth: 0 }}>
                  ...
                  {!latestActual && (
                    <p style={{ color: '#64748b' }}>No actual data available.</p>
                  )}
                </div>
              </div>
              ...
              <div className='enrollmentForecastP2'>
                ...
                <div className="tableSection" style={{ width: '100%' }}>
                  <h3 style={{ color: "#334155", }}>Overall BOSY by School Year</h3>
